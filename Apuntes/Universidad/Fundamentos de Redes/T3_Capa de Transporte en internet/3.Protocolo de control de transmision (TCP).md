...
Cualquiera de los paquetes se puede perder y cualquiera puede tener errores, así que en la memoria del emisor **se hace una copia de cada segmento que se envía** con el objetivo de reenviarlo en caso de necesitarlo. Cuando llega el ACK libero memoria reservada.
...
2. *Ventana deslizante del receptor* -> por si llega desordenado
...
**Ventana útil enmisor **=** Ventana ofertada por el receptor **-** bytes de transito**
