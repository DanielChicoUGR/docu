...
```ad-important
Es el protocolo para el envío de los mensajes de correo electrónico. SMTP se implementa mediante dos prograsmas, que son incluidos ambos en cada mail server
```

### Arquitectura SMTP
?
- **Cliente SMTP** -> que ejecuta el mail serer que está enviando el correo
...
?
1. El usuario origen compone mediante su Agente de Usuario (MUA) un **mensaje digido a la dirección de correo destino**
...
#### Tipo *message*
?
- Permite que un mensaje esté encapsulado por completo dentro de otro. Este esquema es til para reenviar correos electrónicos
