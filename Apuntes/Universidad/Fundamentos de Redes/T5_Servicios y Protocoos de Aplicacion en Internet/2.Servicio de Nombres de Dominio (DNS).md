...
El *espacio de nombres de dominio* tiene una estructura **jerárquica** en forma de árbol centrada en el dominio raíz. Gestionada por el *ICANN*. 
...
*DNS* es un **protocolo de aplicación** para el acceso a una base de datos distribuida con una gestión distribuida con 3 niveles:
?
-  Servidor Raíz
