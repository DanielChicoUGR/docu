...
4. **No coincide** con ninguna entrada de la tabla:
	1. Se genera un mensaje de error
...
- Se reserva una dirección OP parqa poder enciar mensajes a todos los routers del sistema autónomo (Ip -> 224.0.0.9)
- Todos los routers necesitan saber cómo llegar a todos los destinos del sistema automáticamente. Para eso, se usa el vector de distancia.
	...
	- Busca de todos los posibles orígenes a todos los posibles detínos con el menor número de saltos.
